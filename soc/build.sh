...
# it would silently break every existing game .bin. See soc/abi/ABI.md.
python3 "$HERE/abi/check_abi.py" --check \
  "$OUT/software/include/generated/csr.h" "$HERE/abi/abi_v1_csr_map.txt" \
