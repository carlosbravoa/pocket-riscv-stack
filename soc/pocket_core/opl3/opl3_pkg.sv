...
package opl3_pkg;
     ...
     * domain crossings.
     */
    localparam CLK_FREQ = 12.288e6; // Pocket fork: the core's 12.288 MHz domain
    ...
    localparam CLK_DIV_COUNT = 248; // Pocket fork: 12.288e6/248 = 49548 Hz (0.34% below the authentic 49716 Hz)
