...
// Zero-order hold: latch the newest OPL sample. The 49,548 Hz synth vs
// 48 kHz i2s mismatch is inaudible with a simple hold — v0.19.x proved it
// sounds clean. (A linear interpolator was tried in v0.20.1-.4 to chase
// "crispness" but its opl_il[23:8] slice mangled the sign of every negative
// slope -> high-pitched noise, field-confirmed worse. Reverted. If ever
