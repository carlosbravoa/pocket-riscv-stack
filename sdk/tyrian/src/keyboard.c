...
// Start focused: on the Pocket the window is always focused and the shim sends
// no focus events, so a default of false left the game permanently paused
// (tyrian2.c gates gameplay on windowHasFocus). Desktop SDL updates it via events.
