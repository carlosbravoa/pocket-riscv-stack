...
{
#ifndef OF_PC
	/* RVSTACK: bare-metal entry. Bring up the HAL before anything else, and
	 * synthesize argv — crt0_game.S calls main() with garbage registers. */
	extern void sys_init(void);
	sys_init();
	static char *rvstack_argv[] = { (char *)"tyrian", (char *)0 };
	argc = 1;
	argv = rvstack_argv;
#endif
