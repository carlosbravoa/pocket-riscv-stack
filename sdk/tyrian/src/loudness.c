...
#else
// Pocket: OPL FM synthesis is software on the RISC-V core; 44.1 kHz saturates it
// on dense tracks (menu music). 22.05 kHz halves the synth cost and stays well
// within budget while sounding close to the original AdLib rate.
