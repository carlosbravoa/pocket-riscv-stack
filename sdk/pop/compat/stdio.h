/*
 * stdio.h — riscv-stack compat SHADOW header for the SDLPoP port.
 *
 ...
 * Wolf opens ALL its data by plain fopen("PRINCE.DAT"), so unlike Tyrian
 ...
 */
#ifndef RVSTACK_POP_STDIO_SHADOW_H
#define RVSTACK_POP_STDIO_SHADOW_H
