...
// RVSTACK: OFF — truecolor per-pixel alpha overlay (lighting.c dropped from
// build; ACCEL.md forbids per-pixel blend over the frame).
#ifndef POP_RVSTACK
#define USE_LIGHTING
#endif

// Enable screenshot features.
// RVSTACK: OFF — PNG writer (screenshot.c dropped; desktop-only).
#ifndef POP_RVSTACK
...
// RVSTACK: OFF — depends on USE_LIGHTING (truecolor overlay).
#ifndef POP_RVSTACK
