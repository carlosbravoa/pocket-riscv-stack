/*
 * SDL2/SDL.h — shadow header for the quabricks riscv-stack port.
 *
 ...
 * strcmp/rand/malloc, so provide the same courtesy here.
 *
 * MIT (port glue; inherits the game's license, see ../../LICENSE).
 */
#ifndef RVSTACK_QUABRICKS_SDL2_SHADOW_H
#define RVSTACK_QUABRICKS_SDL2_SHADOW_H
