...
#define CSR_MAIN_PAK_ID_ADDR (CSR_BASE + 0x1820L)
#define CSR_MAIN_PAK_ID_SIZE 1
#define CSR_MAIN_PAK_DTADDR_ADDR (CSR_BASE + 0x1824L)
#define CSR_MAIN_PAK_DTADDR_SIZE 1
#define CSR_MAIN_PAK_OFFSET_ADDR (CSR_BASE + 0x1828L)
#define CSR_MAIN_PAK_OFFSET_SIZE 1
#define CSR_MAIN_PAK_LENGTH_ADDR (CSR_BASE + 0x182cL)
#define CSR_MAIN_PAK_LENGTH_SIZE 1
#define CSR_MAIN_PAK_BUSY_ADDR (CSR_BASE + 0x1830L)
#define CSR_MAIN_PAK_BUSY_SIZE 1
#define CSR_MAIN_PAK_ERR_ADDR (CSR_BASE + 0x1834L)
#define CSR_MAIN_PAK_ERR_SIZE 1
#define CSR_MAIN_PAK_SIZE_ADDR (CSR_BASE + 0x1838L)
#define CSR_MAIN_PAK_SIZE_SIZE 1
#define CSR_MAIN_CONT1_ADDR (CSR_BASE + 0x183cL)
#define CSR_MAIN_CONT1_SIZE 1
#define CSR_MAIN_CONT2_ADDR (CSR_BASE + 0x1840L)
#define CSR_MAIN_CONT2_SIZE 1
#define CSR_MAIN_JOY1_ADDR (CSR_BASE + 0x1844L)
#define CSR_MAIN_JOY1_SIZE 1
#define CSR_MAIN_JOY2_ADDR (CSR_BASE + 0x1848L)
#define CSR_MAIN_JOY2_SIZE 1
#define CSR_MAIN_OPL_CMD_ADDR (CSR_BASE + 0x184cL)
#define CSR_MAIN_OPL_CMD_SIZE 1
#define CSR_MAIN_OPL_DBG_ADDR (CSR_BASE + 0x1850L)
#define CSR_MAIN_OPL_DBG_SIZE 1
#define CSR_MAIN_HWFEAT_ADDR (CSR_BASE + 0x1854L)
#define CSR_MAIN_HWFEAT_SIZE 1
#define CSR_MAIN_EXIT_ADDR (CSR_BASE + 0x1858L)
#define CSR_MAIN_EXIT_SIZE 1
#define CSR_MAIN_BOOT_SKIP_ADDR (CSR_BASE + 0x185cL)
#define CSR_MAIN_BOOT_SKIP_SIZE 1
#define CSR_MAIN_SAVE_ADR_ADDR (CSR_BASE + 0x1860L)
#define CSR_MAIN_SAVE_ADR_SIZE 1
#define CSR_MAIN_SAVE_WDAT_ADDR (CSR_BASE + 0x1864L)
#define CSR_MAIN_SAVE_WDAT_SIZE 1
#define CSR_MAIN_SAVE_WR_ADDR (CSR_BASE + 0x1868L)
#define CSR_MAIN_SAVE_WR_SIZE 1
#define CSR_MAIN_SAVE_RD_ADDR (CSR_BASE + 0x186cL)
#define CSR_MAIN_SAVE_RD_SIZE 1
#define CSR_MAIN_SAVE_RDAT_ADDR (CSR_BASE + 0x1870L)
#define CSR_MAIN_SAVE_RDAT_SIZE 1
#define CSR_MAIN_SAVE_ACK_ADDR (CSR_BASE + 0x1874L)
...
static inline void main_opl_cmd_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x184cL));
}
...
static inline void main_save_adr_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1860L));
}
...
static inline void main_save_wdat_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1864L));
}
...
static inline void main_save_rd_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x186cL));
}
